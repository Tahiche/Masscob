...
global $contador;
	$out .= '';
	$out .= '<table id="'.$contador.'"><tr><td><form onsubmit="return formvalidation(this)" method="post" target="_blank" name="subform" id="subform" action="http://www.masscob.com/boletin/subscriber/optIn.php" autocomplete="off">
                                      <input name="idGroup" value="1" type="hidden">
				<img src="./wp-content/themes/masscob/images/newsletter.png" />&nbsp;
			</td><td>
				<input type="hidden" vaiue="_" name="wpnewsletter_name" id="wpnewsletter_name"/>
			</td><td>
				<input name="email" onchange="emailvalidation(this,\'Invalid Email\');"  id="wpnewsletter_email"  value="your-email" type="text">&nbsp;
                                <input name="idlist[]" value="13" type="hidden">
			</td><td>
				<img class="pointer" id="submit_subform" onclick="document.getElementById(\'subform\').submit()" src="./wp-content/themes/masscob/images/ok2.png" /></form>
			</td></tr></table>
			';
