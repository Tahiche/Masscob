		...
		<div class="post" id="post-<?php the_ID(); ?>">
			...
			<div class="entry">
				...
				elseif (get_the_ID()==2) {
					...
					//echo "XXXXXX22222222222222222222222xxxxxxxxxxxxx";
					
					$T_colonne = explode('[colonne]', get_the_content('<p class="serif">' . __('Read the rest of this page &raquo;', 'kubrick') . '</p>')); 
				...
				$content = str_replace(']]>', ']]&gt;', $content);
					...
					$T_page = explode('[formulaire]', $content); 
					
					 //$T_colonne = explode('[colonne]', do_shortcode($T_page[0])); 
