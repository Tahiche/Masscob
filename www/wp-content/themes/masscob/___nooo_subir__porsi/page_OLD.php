...
'.$_POST['message'];
				...
				<?php		
					...
					if(get_the_ID()==5 OR get_the_ID()==6 OR get_the_ID()==1577)
					{
		...
		if(get_the_ID()==6){
			...
			echo '<a href="'.get_bloginfo('url').'/summer/" id="bb_img_summer"></a>';
		...
		if(get_the_ID()==1577){
			echo '<div id="bb_separator">&nbsp;</div>';
			echo '<a href="'.get_bloginfo('url').'/summer/" id="bb_img_summer" style="background-position:bottom left;"></a>';
