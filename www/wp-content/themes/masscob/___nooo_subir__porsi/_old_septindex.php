...
get_header(); ?>
	...
	?>
	<div id="video" onclick="this.style.display='none';document.getElementById('video2').style.display='none'">
		<!-- height:550px; width:816px; -->
	</div>
	
		<?php if(!empty($_GET['movie']) AND $_GET['movie']=="spring_summer_10"){ ?>
		<div id="video2">
 ...
 if(!empty($_GET['movie']) AND $_GET['movie']=="spring_autum_winter_10_11")
	...
	<div id="content" class="narrowcolumn" role="main">
		...
		?>
			<img style="float:left;" src="<?php bloginfo('stylesheet_directory'); ?>/images/sept12/<?php echo $T_image[rand(0,4)] ?>.jpg" />
