...
/******************************** PARA PONER LOS VIDEOS EN ESTÁ PÁGINA EN VEZ DE EN DONDE SALEN (CODIGO EXTRAIDO DE wp-contents/themes/mascob/index.php) **************************************/
                                ...
                                <?php
								  ...
								  else if(!empty($_GET['movie']) AND $_GET['movie']=="summer_11")
								  {
								   ...
								   <?php
												  ...
												  else if(!empty($_GET['movie']) AND $_GET['movie']=="autum_winter_11_12")
												  {
							?>
							<div id="video2">
								<!-- height:460px; width:600px; -->
	...
	/**************************************************************************************************************************************************************************/
					?>	
                        ...
                        <a href="<?php echo  get_bloginfo('url'); ?>/archives-video"><img src="<?php echo  get_bloginfo('url'); ?>/wp-content/themes/masscob/images/film_aut_win_12.gif" style="margin-right:64px;" /></a>
