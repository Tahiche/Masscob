...
'.$_POST['message'];
				...
				/*	http://www.masscob.com/masscobv8.flv
					...
					?>	
						...
						<div id="archive_video">
                                                        <a href="<?php echo  get_bloginfo('url'); ?>/?video=true&movie=spring_summer_12"><img src="<?php echo  get_bloginfo('url'); ?>/wp-content/themes/masscob/images/film_spring_summer_12.gif" style="margin-right:64px;" /></a>
                                                        <a href="<?php echo  get_bloginfo('url'); ?>/?video=true&movie=autum_winter_11_12"><img src="<?php echo  get_bloginfo('url'); ?>/wp-content/themes/masscob/images/film_autum_winter_11_12.gif" style="margin-right:64px;" /></a>
                                                        <a href="<?php echo  get_bloginfo('url'); ?>/?video=true&movie=summer_11"><img src="<?php echo  get_bloginfo('url'); ?>/wp-content/themes/masscob/images/film_spring_summer_11.gif" style="margin-right:64px;" /></a>
							<a href="<?php echo  get_bloginfo('url'); ?>/?video=true&movie=spring_autum_winter_10_11"><img src="<?php echo  get_bloginfo('url'); ?>/wp-content/themes/masscob/images/film_autum_winter_10_11.gif" style="margin-right:64px;" /></a>
						
							<a href="<?php echo  get_bloginfo('url'); ?>/?video=true&movie=spring_summer_10"><img src="<?php echo  get_bloginfo('url'); ?>/wp-content/themes/masscob/images/film_spring_summer_10.gif" /></a>
						</div>
